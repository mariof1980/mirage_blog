...
class AgregarComentarioView(CreateView):
    ...
    form_class=forms.AgregarComentarioForm
    template_name = 'blog/forms/agregar_comentario.html'
    ...
    def get_success_url(self):
        # Redirigir al detalle del artículo que originó el comentario
         return reverse_lazy('articulo', kwargs={'articulo_slug': self.kwargs.get('articulo_slug')})
